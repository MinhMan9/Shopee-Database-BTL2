...
def customer_dashboard():
    ...
    # --- TRUY VẤN MỚI: VOUCHER VÀ ÁP DỤNG FUNCTION KIỂM TRA ---
    sql_vouchers = """
    SELECT 
    ...
    # Lặp và kiểm tra tính hợp lệ cho từng voucher
    ...
    return render_template('customer_dashboard.html', 
                           ...
                           vouchers_with_status=vouchers_with_status, # Dữ liệu voucher mới
